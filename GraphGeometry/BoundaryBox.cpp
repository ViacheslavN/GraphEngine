...
namespace GraphEngine
{
	namespace GraphGeometry
	{
		...
		BoundaryBox::BoundaryBox(const BoundaryBox& bbox)
			: type(bbox.type)
			, xMin(bbox.xMin)
			, xMax(bbox.xMax)
			, yMin(bbox.yMin)
		...
		BoundaryBox& BoundaryBox::operator=(const BoundaryBox& bbox)
		{
			if (this == &bbox)
				return *this;
		...
		bool BoundaryBox::operator==(const BoundaryBox &bbox) const
		{
			if (type != bbox.type)
				return false;
		...
		bool BoundaryBox::DoesInclude(const BoundaryBox &bbox, bool useZ /*= false*/, bool useM /*= false*/) const
		{
		...
		bool BoundaryBox::Contains(const BoundaryBox &bbox, bool useZ, bool useM) const
		{
			return DoesInclude(bbox, useZ, useM);
		}

		bool BoundaryBox::Intersects(const BoundaryBox &bbox, bool useZ, bool useM) const
		{
			if (type == bbox_type_invalid || bbox.type == bbox_type_invalid)
				return false;
		...
		BoundaryBox& BoundaryBox::Expand(const BoundaryBox &bbox)
		{
			if (this == &bbox)
				return *this;
